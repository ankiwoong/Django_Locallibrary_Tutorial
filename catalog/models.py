...
class Author(models.Model):
    ...
    date_of_birth = models.DateField(
        null=True, blank=True, verbose_name="date_of_birth",
    )
...
class Genre(models.Model):
    name = models.CharField(
        max_length=200, help_text="Enter a literary genre (e.g. Science Fiction)",
    )
...
class Book(models.Model):
    ...
    language = models.ForeignKey(
        "Language", on_delete=models.SET_NULL, null=True, verbose_name="langue",
    )
...
class BookInstance(models.Model):
    ...
    book = models.ForeignKey(
        "Book", on_delete=models.SET_NULL, null=True, verbose_name="delivered",
    )
